...
from .models import Hospedaje, Viaje, Vuelo
...
class CreateViajesView(CreateView):
     model = Viaje
...
class CreateVuelosView(CreateView):
     model = Vuelo
...
class CreateHospedajeView(CreateView):
     model = Hospedaje
...
class UpdateVueloPageView(UpdateView):
...
class UpdateHospedajePageView(UpdateView):
     template_name = 'EditarVuelo.html'
     model = Hospedaje
     success_url = reverse_lazy('hospedaje')
     fields = 'ciudad','beneficios','presio','img',
